...
mod_footer_ui <- function(
    ...
    align = "center",
    class = "footer",
    app_info = gmhcommunities:::app_info,
    client_info = gmhcommunities:::client_info,
    developer_info = gmhcommunities:::developer_info,
  ...
  # www_dir <- system.file("www", package = "gmhcommunities")
  # if (nzchar(www_dir) && !"www" %in% names(shiny::resourcePaths())) {
  #   shiny::addResourcePath("www", www_dir)
  # } else if (!nzchar(www_dir)) {
  #   cli::cli_abort("The 'www' directory was not found in the package.")
  # }
