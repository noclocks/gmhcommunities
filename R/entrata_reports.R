...
entrata_reports <- function(
  ...
  validate_entrata_method(endpoint = "reports", method = method_name)
  method_version <- get_default_method_version("reports", method_name)
  validate_entrata_method_params(endpoint = "reports", method = method_name, params = method_params)
...
entrata_reports_list <- function(
  ...
  req <- entrata_reports(
    ...
    entrata_req_body(
      ...
      version = get_default_method_version("reports", "getReportList")
    )
