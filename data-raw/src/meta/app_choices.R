...
portfolio_choices <- portfolios$portfolio_id |>
  setNames(portfolios$portfolio_name)

assignments <- portfolio_assignments

# properties --------------------------------------------------------------

property_choices <- mem_get_entrata_property_ids()
...
market_survey_input_choices <- list(
  ...
  fees = list(
    ...
    fee_structure = c(
      "App Fee Waived-Admin Due",
      "Admin Fee Waived-App Due",
      "Both Fees Waived",
      "Both Fees Due"
    ),
    fee_type = c(
  ...
  floorplans = list(
    ...
    floorplan_descriptions_commonwealth = c(
      "S1",
      "S2",
      "S3",
      "S4",
    ...
    floorplan_descriptions_boylston = c(
      "1a",
      "1e",
      "1f",
      "1g",
    ...
    floorplan_descriptions_vanness = c(
      "S2",
      "S3a",
      "S3b",
      "A1a",
    ...
    floorplan_descriptions_bower = c(
      "a1",
      "a3",
      "e2",
      "e8",
